...
Project Name : College_ChatBot

Developers : Md Marjul Hossain
...
screen_1 = PhotoImage(file = 'sms.png')
...
option_1 = Label (frame_topic , text = '1- Administration' , font = 'Verdana 15 italic' , bg = c1 , fg= c2)
...
option_2 = Label (frame_topic , text = '2- Academic' , font = 'Verdana 15 italic' , bg = c1 , fg= c2)
...
option_3 = Label (frame_topic , text = '3- Examination' , font = 'Verdana 15 italic' ,bg = c1 , fg= c2)
...
option_4 = Label (frame_topic , text = '4- Faculty Details   ' , font = 'Verdana 15 italic' , bg = c1 , fg= c2)
...
option_5 = Label (frame_topic , text = '5- Security Office ' , font = 'Verdana 15 italic' , bg = c1 , fg= c2)
